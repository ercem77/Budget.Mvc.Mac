...
$(".openUpdateTransactionModalBtn").on("click", function () {
    ...
    var amount = $(this).closest('tr').find('td:eq(2) .transaction-amount div').html();
    var name = $(this).closest('tr').find('td:eq(3) .transaction-name').html();
    ...
    $("#insert-transaction-form #InsertTransaction_CategoryId option[value=" + $.trim(categoryId) + "]").attr('selected', 'selected');
